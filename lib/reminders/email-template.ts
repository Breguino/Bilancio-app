...
// e stessa intestazione chiara con la tessera del marchio.
      ...
      (r) => `<tr>
        <td style="padding:14px 0;border-top:1px solid ${C.borderSoft};">
          <a href="${siteUrl}${r.href}" style="display:block;text-decoration:none;color:inherit;">
            <p style="margin:0 0 3px;font-weight:700;color:${C.ink};">${escapeHtml(r.contactName)}</p>
            <p style="margin:0;color:${C.inkSecondary};">${escapeHtml(r.note)}</p>
          </a>
        </td>
      </tr>`
    )
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:${C.card};border-radius:16px;border:1px solid ${C.border};overflow:hidden;">
            ...
            <tr>
              <td style="padding:32px 32px 8px;font-family:${FONT_STACK};font-size:15px;line-height:1.7;color:${C.ink};">
                ...
                <p style="margin:0 0 8px;color:${C.inkSecondary};">${escapeHtml(intro)}</p>
            ...
            <tr>
              <td align="center" style="padding:8px 32px 32px;">
                <a href="${siteUrl}/contacts" style="display:inline-block;background-color:${C.accent};color:#ffffff;font-family:${FONT_STACK};font-weight:700;font-size:14px;text-decoration:none;border-radius:999px;padding:12px 26px;">${ctaLabel}</a>
              </td>
            </tr>
          </table>
        </td>
