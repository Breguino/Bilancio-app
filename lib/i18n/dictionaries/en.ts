...
const en: Dictionary = {
  ...
  contacts: {
    ...
    noSearchResults: "No contact with that name.",
    nameLabel: "Name",
    emailLabel: "Email",
    phoneLabel: "Phone",
    notesLabel: "Notes",
  ...
  compare: {
    ...
    subtitle: "Pick the two months: the rest of the page follows.",
    monthALabel: "Month A",
    monthBLabel: "Month B",
    verdictMore: "In {b} you kept {x} more than in {a}.",
    verdictLess: "In {b} you kept {x} less than in {a}.",
    verdictSame: "The two months end the same way.",
  ...
  yearly: {
    ...
    monthByMonthTitle: "Month by month",
    extremesTitle: "Extremes",
    bestMonth: "Best month",
    worstMonth: "Worst month",
    averageMonth: "Monthly average",
    averageMonthSub: "what is left, on average",
  ...
  recurring: {
    ...
    newAction: "New rule",
    perMonthOut: "Goes out each month",
    perMonthIn: "Comes in each month",
    nextUp: "Next up",
    fromOneRule: "from 1 active rule",
    fromNRules: "from {n} active rules",
    noActiveRules: "no active rules",
    none: "None",
    pauseHint: "The switch pauses a rule without deleting it",
  ...
  goals: {
    ...
    newAction: "New goal",
    setAsidePre: "You have set aside",
    setAsideOf: "of the",
    setAsideSuffix: "you aimed for",
    missingPre: "Still missing",
  ...
  dashboard: {
    ...
    formCategoryPlaceholder: "E.g. Housing",
    typeLabel: "Type",
    expenseOption: "Expense",
    incomeOption: "Income",
    contactLabel: "Client",
  ...
  demo: {
    metaTitle: "See inside before you sign up — Bilancino",
    metaDescription:
      "A tour of Bilancino's real screens: the month at a glance, budgets by category, recurring transactions, goals, clients and statistics. No account needed.",
    eyebrow: "Demo",
    heroTitle: "See inside, before you sign up.",
    heroBody:
      "These are the real screens of the app, taken from a demo account with made-up data. Pick a feature below and see how it works: by the end you'll know whether it suits you.",
    caption: "A screen from the app · example data",
    note: "The figures you see are the ones the app actually computes from that data, forecasts and confidence intervals included. Your own account starts empty: none of these transactions will be in it.",
    screens: [
      {
        key: "panoramica",
        tab: "Overview",
        title: "The month on one screen",
        body: "Income, expenses and net savings for the month, with the change from the month before. Below, the budgets closing in on their limit and the reminders due in the next few days: the two things you want to know the moment you open the app.",
        alt: "Bilancino's Overview: income, expenses and net for the month, budgets by category and upcoming reminders.",
      },
      {
        key: "budget",
        tab: "Budgets",
        title: "A cap per category",
        body: "Set a monthly limit for each spending category and the bar changes colour as you approach it. At the top you see how much of your income you've already committed and how much is still unassigned.",
        alt: "Bilancino's Budget page, with monthly limits per category and the share of income already assigned.",
      },
      {
        key: "ricorrenti",
        tab: "Recurring",
        title: "Fixed costs record themselves",
        body: "Rent, subscriptions, fees that come back every month: you set the frequency and start date once, and the transaction is created when it falls due. If you don't open the app for a while, the missed occurrences are waiting when you return.",
        alt: "Bilancino's recurring transactions page, showing the frequency and next date for each entry.",
      },
      {
        key: "obiettivi",
        tab: "Goals",
        title: "One target at a time",
        body: "Create a goal with an amount to reach and add a contribution whenever you like, with no constraints and no imposed deadlines. The bar tells you where you stand.",
        alt: "Bilancino's Goals page, with the progress bar towards the target amount.",
      },
      {
        key: "contatti",
        tab: "Clients",
        title: "Who paid you, and how much",
        body: "Every client has their own page, with the income you've linked to them, notes, and reminders with due dates. This is the part budgeting apps don't have: it tells you what each relationship has been worth, not just what came in overall.",
        alt: "Bilancino's Clients page, showing the total income linked to each contact.",
      },
      {
        key: "statistiche",
        tab: "Statistics",
        title: "How next month will go",
        body: "A savings forecast built from your past months, with the mean, standard deviation and a 95% confidence interval. Further down, the expenses that break your usual pattern. It's a separate section: if it doesn't interest you, the rest works just the same.",
        alt: "Bilancino's Statistics page: savings forecast, monthly average and confidence interval.",
      },
      {
        key: "confronta",
        tab: "Compare",
        title: "Two months side by side",
        body: "Pick two months and see what changed category by category, with the difference as a percentage. It's how you tell whether a bad month was a one-off or the start of a habit.",
        alt: "Bilancino's Compare page, with two months side by side and the difference for each category.",
      },
    ],
    ctaTitle: "Sound right? Your account starts empty.",
    ctaBody: "An email and a password is all it takes. No credit card, no timed trial.",
  },
  novita: {
