...
const en: Dictionary = {
  ...
  privacy: {
    ...
    dataCollectedParagraphs: [
      ...
      "The personal details required at registration: first name, last name, date of birth and residence. The date of birth also serves to check the 18-year requirement set out in the terms; if you sign in with Google, I ask you to fill in these same details on your first visit.",
      "The financial data you enter yourself: transactions, categories, budgets, savings goals, contacts and notes, recurring transactions. Nothing else — I don't ask for a phone number or payment details, because I don't need them to make the app work.",
  ...
  termini: {
    ...
    yourResponsibilityParagraphs: [
      ...
      "Bilancino is meant for adult use: at registration I ask for your first name, last name, date of birth and residence, and the date of birth is used to check that you are at least 18. You are responsible for the accuracy of these details; if you sign in with Google, I ask for them on your first visit.",
    ],
  ...
  auth: {
    ...
    profileFields: {
      ...
      residencePlaceholder: "Street, number, city",
    },
    completeProfile: {
      ...
      missingFieldsError: "Please fill in every field: first name, last name, date of birth and residence.",
