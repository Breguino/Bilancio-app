const it = {
  ...
  home: {
    ...
    ctaSeeDemo: "Guarda com'è dentro →",
  ...
  contacts: {
    ...
    newAction: "Nuovo contatto",
    searchPlaceholder: "Cerca un contatto",
    noSearchResults: "Nessun contatto con questo nome.",
    nameLabel: "Nome",
    emailLabel: "Email",
    phoneLabel: "Telefono",
    notesLabel: "Note",
  ...
  compare: {
    ...
    subtitle: "Scegli i due mesi: tutto il resto della pagina si riallinea.",
    monthALabel: "Mese A",
    monthBLabel: "Mese B",
    verdictMore: "A {b} ti è rimasto {x} in più che a {a}.",
    verdictLess: "A {b} ti è rimasto {x} in meno che a {a}.",
    verdictSame: "I due mesi si chiudono allo stesso modo.",
  ...
  yearly: {
    ...
    monthByMonthTitle: "Mese per mese",
    extremesTitle: "Estremi",
    bestMonth: "Mese migliore",
    worstMonth: "Mese peggiore",
    averageMonth: "Media mensile",
    averageMonthSub: "quello che resta, in media",
  ...
  recurring: {
    ...
    newAction: "Nuova regola",
    perMonthOut: "Ogni mese esce",
    perMonthIn: "Ogni mese entra",
    nextUp: "Prossima",
    fromOneRule: "da 1 regola attiva",
    fromNRules: "da {n} regole attive",
    noActiveRules: "nessuna regola attiva",
    none: "Nessuna",
    pauseHint: "L'interruttore mette in pausa senza cancellare",
  ...
  goals: {
    ...
    newAction: "Nuovo obiettivo",
    setAsidePre: "Hai messo da parte",
    setAsideOf: "sui",
    setAsideSuffix: "che ti sei dato",
    missingPre: "Mancano",
  ...
  budget: {
    ...
    newCategoryAction: "Nuova categoria",
    remainingShort: "restano",
    categoryLabel: "Categoria",
    categoryPlaceholder: "Es. Casa",
  ...
  dashboard: {
    ...
    formCategoryPlaceholder: "Es. Casa",
    typeLabel: "Tipo",
    expenseOption: "Spesa",
    incomeOption: "Entrata",
    contactLabel: "Cliente",
    ...
    comparedToPrefix: "rispetto a",
    filterAllTypes: "Tutti",
    moreFilters: "Altri filtri",
    lessFilters: "Meno filtri",
    remainingLabel: "Ti restano",
    balanceLabel: "saldo",
    countOne: "{n} movimento",
    countMany: "{n} movimenti",
    seeAllCount: "Vedi tutti i {n} →",
    seeAllShort: "Apri l'elenco completo →",
  ...
  demo: {
    metaTitle: "Guarda com'è dentro, senza registrarti — Bilancino",
    metaDescription:
      "Un giro fra le schermate vere di Bilancino: panoramica del mese, budget per categoria, movimenti ricorrenti, obiettivi, clienti e statistiche. Nessun account richiesto.",
    eyebrow: "Demo",
    heroTitle: "Guarda com'è dentro, prima di registrarti.",
    heroBody:
      "Queste sono le schermate vere dell'app, riprese da un account dimostrativo con dati inventati. Scegli una funzione qui sotto e guarda com'è fatta: quando avrai finito, saprai già se fa per te.",
    caption: "Schermata dell'app · dati di esempio",
    note: "I numeri che vedi sono quelli che l'app calcola davvero su quei dati, previsioni e intervalli di confidenza compresi. Il tuo account parte vuoto: nessuno di questi movimenti ci sarà dentro.",
    screens: [
      {
        key: "panoramica",
        tab: "Panoramica",
        title: "Il mese in una schermata",
        body: "Entrate, uscite e risparmio netto del mese, con la variazione rispetto al mese prima. Sotto, i budget che si stanno avvicinando al limite e i promemoria in scadenza nei prossimi giorni: le due cose che vuoi sapere appena apri l'app.",
        alt: "La Panoramica di Bilancino: entrate, uscite e netto del mese, budget per categoria e promemoria in scadenza.",
      },
      {
        key: "budget",
        tab: "Budget",
        title: "Un tetto per categoria",
        body: "Assegni un limite mensile a ogni categoria di spesa e la barra cambia colore man mano che ti avvicini. In alto vedi quanto del tuo reddito hai già impegnato e quanto ti resta ancora da assegnare.",
        alt: "La pagina Budget di Bilancino, con i limiti mensili per categoria e la quota di entrate già assegnata.",
      },
      {
        key: "ricorrenti",
        tab: "Ricorrenti",
        title: "Le spese fisse si registrano da sole",
        body: "Affitto, abbonamenti, compensi che tornano ogni mese: imposti frequenza e data di inizio una volta sola, e il movimento viene creato alla scadenza. Se non apri l'app per un po', al rientro trovi anche le occorrenze arretrate.",
        alt: "La pagina dei movimenti ricorrenti di Bilancino, con frequenza e prossima data di ogni voce.",
      },
      {
        key: "obiettivi",
        tab: "Obiettivi",
        title: "Un traguardo alla volta",
        body: "Crei un obiettivo con un importo da raggiungere e aggiungi un contributo quando ti va, senza vincoli e senza scadenze imposte. La barra ti dice a che punto sei.",
        alt: "La pagina Obiettivi di Bilancino, con la barra di avanzamento verso l'importo target.",
      },
      {
        key: "contatti",
        tab: "Clienti",
        title: "Chi ti ha pagato, e quanto",
        body: "Ogni cliente ha la sua scheda, con le entrate che gli hai collegato, le note e i promemoria con scadenza. È la parte che le app di budget non hanno: dice quanto ha fruttato ciascun rapporto, non solo quanto è entrato in totale.",
        alt: "La pagina Clienti di Bilancino, con le entrate totali collegate a ciascun contatto.",
      },
      {
        key: "statistiche",
        tab: "Statistiche",
        title: "Come andrà il mese prossimo",
        body: "Una previsione del risparmio costruita sui tuoi mesi passati, con media, deviazione standard e intervallo di confidenza al 95%. Più sotto, le spese che escono dai tuoi schemi abituali. È una sezione a parte: se non ti interessa, il resto funziona lo stesso.",
        alt: "La pagina Statistiche di Bilancino: previsione del risparmio, media mensile e intervallo di confidenza.",
      },
      {
        key: "confronta",
        tab: "Confronta",
        title: "Due mesi affiancati",
        body: "Scegli due mesi e vedi categoria per categoria cosa è cambiato, con la differenza in percentuale. Serve a capire se un mese storto è stato un caso o l'inizio di un'abitudine.",
        alt: "La pagina Confronta di Bilancino, con due mesi affiancati e la differenza per ogni categoria.",
      },
    ],
    ctaTitle: "Ti torna? Il tuo account parte da vuoto.",
    ctaBody: "Bastano un'email e una password. Nessuna carta di credito, nessun periodo di prova a tempo.",
  },
  novita: {
