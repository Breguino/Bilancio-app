  ...
  return (
    <form action={setLocale} aria-label={label} className="shrink-0">
      ...
      <button
        ...
        className="relative inline-flex items-center w-16 h-8 rounded-full border border-border dark:border-neutral-700 bg-surface-alt dark:bg-neutral-800 transition-colors hover:border-accent/50"
      >
        ...
        <span
          className={`absolute top-0.5 left-0.5 w-7 h-7 rounded-full bg-white dark:bg-neutral-900 shadow-sm flex items-center justify-center text-[10px] font-bold text-accent transition-transform duration-200 ease-out ${
