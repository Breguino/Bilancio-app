...
export function MobileMenu({ items }: { items: MenuItem[] }) {
  ...
  return (
    <>
      ...
      <div
        className="absolute inset-x-0 top-full z-30 grid transition-[grid-template-rows] duration-300 ease-out bg-white dark:bg-neutral-900 border-b border-border dark:border-neutral-800 shadow-xl"
